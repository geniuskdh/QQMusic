$(function(){
   /*建立一个新数组 存储歌词*/
   var musics=[
     {src:'1.mp3',name:'采薇',zuoze:'HITA',shichang:'05:23'},
...
/*获取dom对象的audio*/
   ...
   $('.delete').on('click',function(){
      ...
      musics.splice($(this).currenIndex,1);
         $('.sl').text(musics.length);
...
/*显示时间提示 他的位置跟着鼠标的位置移动  left=鼠标到事件源的位置-自己宽度得到一半*/
      $('.ggqhc').css({display:'block',left:e.offsetX-$('.ggqhc').width()/2});
      /*获取播放当前的时长*/
